//
//  PausePanelNode.swift
//  Gravicaine
//
//  Created by stephen ball on 14/06/2018.
//  Copyright © 2018 Stephen Ball. All rights reserved.
//
import SpriteKit

class PausePanelNode: SKSpriteNode {
    ...
    func fadeIn(completion: @escaping ()->() = {}) {
        ...
        label.alpha = 0.0
        label.position.y -= PausePanelNode.FadeInTranslationY
        
        self.animate(alpha: 1.0, yTranslation: PausePanelNode.FadeInTranslationY, completion: completion)
        
    }
    
    func fadeOut(completion: @escaping ()->() = {}) {
        
        self.animate(alpha: 0.0, yTranslation: PausePanelNode.FadeInTranslationY) {
            self.label.position.y -= PausePanelNode.FadeInTranslationY
            completion()
        }
